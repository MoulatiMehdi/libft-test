...
/*   Updated: 2024/11/09 14:15:20 by mmoulati         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	t_args args[] = {
		...
		{
			.s1 = "aaaaaa____hello world",
			.s2 = "abcdefghijklmnopqrstuvwxyz ",
			.expected = "____",
		},
		{
			.s1 = "abcdez____hello world",
			.s2 = "abcdefghijklmnopqrstuvwxyz",
			.expected = "____hello ",
		},
	};
